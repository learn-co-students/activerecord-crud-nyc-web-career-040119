...
def can_be_found_updated_and_saved
  ...
  awe = Movie.find_by(title: "Awesome Flick")
  awe.title = "Even Awesomer Flick"
  awe.save
end
...
def can_update_using_update_method
  ...
  Movie.update(wat.id, title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  Movie.delete(bad_movie.id)
  # Movie.destroy(bad_movie.id)
end
