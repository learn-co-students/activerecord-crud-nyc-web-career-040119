...
def can_be_found_updated_and_saved
  ...
  update_awesome = Movie.where(title: "Awesome Flick").first.update(title: "Even Awesomer Flick")
  update_awesome
end
...
def can_update_using_update_method
  ...
  wat_id = Movie.find_by(title: "Wat?")
  Movie.update(wat_id.id, title: "Wat, huh?")
end
